...
INSERT INTO USERS(PERMISSION,FNAME,LNAME,BIRTH_DAY,WORK_EMAIL,PERSONAL_EMAIL,PHONE,PASSWORD,DEPARTMENT) VALUES(0,"Caleb","Riggs","1997-11-04","criggs2892@flpoly.org","madscientist626@verizon.net","7277102842",MD5("password"),1);
INSERT INTO USERS(PERMISSION,FNAME,LNAME,BIRTH_DAY,WORK_EMAIL,PERSONAL_EMAIL,PHONE,PASSWORD,DEPARTMENT) VALUES(1,"Jared","Davis","1991-04-23","jareddavis0237@flpoly.org","jdavis@gmail.com","8139999999",MD5("password"),1);
INSERT INTO USERS(PERMISSION,FNAME,LNAME,BIRTH_DAY,WORK_EMAIL,PERSONAL_EMAIL,PHONE,PASSWORD,DEPARTMENT) VALUES(0,"Gabriel","Hutchison","1997-08-11","ghutchison2600@flpoly.org","","8138082533",MD5("password"),2);
INSERT INTO USERS(PERMISSION,FNAME,LNAME,BIRTH_DAY,WORK_EMAIL,PERSONAL_EMAIL,PHONE,PASSWORD,DEPARTMENT) VALUES(1,"William","Bell","1996-06-21","williambell0161@flpoly.org","","12345678900",MD5("password"),3);
INSERT INTO USERS(PERMISSION,FNAME,LNAME,BIRTH_DAY,WORK_EMAIL,PERSONAL_EMAIL,PHONE,PASSWORD,DEPARTMENT) VALUES(1,"Thomas","Carter","1996-06-21","thomascarter@flpoly.org","","12345678900",MD5("password"),3);
INSERT INTO USERS(PERMISSION,FNAME,LNAME,BIRTH_DAY,WORK_EMAIL,PERSONAL_EMAIL,PHONE,PASSWORD,DEPARTMENT) VALUES(1,"Henrique","Bolivar","1996-02-21","henriquebolivar1000@flpoly.org","","12345678900",MD5("calebRox"),3);
