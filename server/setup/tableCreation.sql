...
INSERT INTO TICKETS (CATEGORY,CLIENT,TITLE,DESCRIPTION,ASSIGNEE_ID,OPEN_STATUS,PRIORITY) VALUES(2,1,"I have an internet question","My internet won't connect. Could you help with that?","[1]",TRUE,3);
...
INSERT INTO TICKETS (CATEGORY,CLIENT,TITLE,DESCRIPTION,ASSIGNEE_ID,OPEN_STATUS,PRIORITY) VALUES(2,1,"Blue screen of death","My internet won't connect. Could you help with that?","[2]",TRUE,3);
...
INSERT INTO TICKETS (CATEGORY,CLIENT,TITLE,DESCRIPTION,ASSIGNEE_ID,OPEN_STATUS,PRIORITY) VALUES(2,1,"BSOD","BSOD, can't connect to the internet so I just attached a picture instead.","[2]",TRUE,3);
INSERT INTO TICKETS (CATEGORY,CLIENT,TITLE,DESCRIPTION,ASSIGNEE_ID,OPEN_STATUS,PRIORITY) VALUES(2,1,"Photoshop won't install","I can't get Photoshop to install what am i doing wrong","[3]",TRUE,3);
...
INSERT INTO TICKETS (CATEGORY,CLIENT,TITLE,DESCRIPTION,ASSIGNEE_ID,OPEN_STATUS,PRIORITY) VALUES(2,1,"Drivers won't install error","You need to give me assistance sometimes","[4]",TRUE,3);
